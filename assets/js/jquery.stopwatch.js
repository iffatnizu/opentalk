(function($) {
	jQuery.fn.stopwatch = function() {
		...
		clock.append('<input type="button" class="start" value="Start" style="display:none"/>');
		clock.append('<input type="button" class="stop" value="Stop" style="display:none"/>');
		clock.append('<input type="button" class="reset" value="Reset" style="display:none"/>');
